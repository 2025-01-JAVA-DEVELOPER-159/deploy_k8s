...
# Service IP( (pod-shopping,pod-customer,pod-order) )로 요청
[root@k8s-master sample]# curl 20.96.169.130:8080
Order Service.
[root@k8s-master sample]# curl 10.104.96.176:8080
Shopping Service.
...
Order Service.
[root@k8s-master sample]# curl 192.168.56.32 
curl: (7) Failed to connect to 192.168.56.32 port 80: Connection refused
[root@k8s-master sample]# curl 192.168.56.32:31542/
curl: (7) Failed to connect to 192.168.56.32 port 31542: Connection refused
